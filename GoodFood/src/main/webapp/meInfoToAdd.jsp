...
<body>
	...
	<main class="main" role="main">
		...
		<div class="wrap clearfix">
				...
				<!--form  -->
						<form id="formFood" action="${pageContext.request.contextPath}/customer/addMe"  enctype="multipart/form-data"  method="post">
							<section>
								...
								<h5>昵称：</h5>
								<div class="f-row">	
									<div class="third"><input type="text"  placeholder=" 昵称"  name="nickname"/></div>
								</div>
								<h5>喜欢的食谱：</h5>
								<div class="f-row">	
									<div class="third"><input type="text" placeholder=" 喜欢的食谱"  name="likerecipe"/></div>
								</div>
								<h5>喜欢的厨具：</h5>
								<div class="f-row">	
									<div class="third"><input type="text" placeholder=" 喜欢的厨具"  name="likekitchenware"/></div>
								</div>
								<h5>喜欢的调味料：</h5>
								<div class="f-row">	
									<div class="third"><input type="text" placeholder=" 喜欢的调味料"  name="likeseasoning"/></div>
								</div>
			...
			<!--发布提交  -->		
							<div class="f-row full">
								<input type="submit"  class="button" id="submitRecipe" value="提交 " />
							</div>
						</form>
