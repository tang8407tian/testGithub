	...
	<main class="main" role="main">
		...
		<div class="wrap clearfix">
			...
			<div class="row">
				...
				<!--form  -->
						<form id="formFood" action="${pageContext.request.contextPath}/recipematerail/save" method="post">
							
							
				<!--RecipematerailEntity  食谱原料信息  -->
							<section>
								<h2>材料</h2>
								<div id="materailBOX">
								...
								<div class="f-row full">
									<button type="button" class="add"  onclick="addmaterail2()">添加成分</button>
								</div>								
							</section>	
		  	<!--//RecipematerailEntity  食谱原料信息  -->
